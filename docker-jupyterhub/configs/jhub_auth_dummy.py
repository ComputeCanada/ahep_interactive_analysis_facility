...
c.DummyAuthenticator.password = "abc"
...
def pre_spawn_hook(spawner):
    ...
    try:
        ...
        #subprocess.check_call(['cp', '/home/root/.bashrc', '/home/%s/'%username])

c.Spawner.pre_spawn_hook = pre_spawn_hook

c.Spawner.cmd=["jupyter-labhub"]

c.Spawner.env_keep = ['PATH', 'PYTHONPATH', 'CONDA_ROOT', 'CONDA_DEFAULT_ENV', 'VIRTUAL_ENV', 'LANG', 'LC_ALL', 'JUPYTERHUB_SINGLEUSER_APP','LD_LIBRARY_PATH','LIBPATH','PATH','CLING_STANDARD_PCH','JUPYTER_CONFIG_DIR','ROOTSYS','DYLD_LIBRARY_PATH','SHLIB_PATH','CMAKE_PREFIX_PATH','ROOT_INCLUDE_PATH','PLOTUTILSVERSION','PLOTUTILSTYPE','PLOTUTILSROOT']
...
#  Default: '/home/tejinc/Programs/anaconda/anaconda2/envs/coffea/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/tejinc/Programs/anaconda/anaconda2/envs/coffea/share/jupyterhub'
...
# c.Spawner.cmd = ['source ~/.bashrc', 'jupyterhub-singleuser']
